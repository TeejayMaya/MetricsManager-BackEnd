...
class GeneralService {
    ...
    public static function send_pushnotificationtoone($userid,$title,$content,$media="https://mylagosapp.mobi/images/logo.png") { //Function to send push notifications
        //Start cURL
                $curl = curl_init();
                curl_setopt_array($curl, array(
                CURLOPT_URL => "https://management-api.wonderpush.com/v1/deliveries?accessToken=Y2YzNGJkMDNlMTJlOTZjODk4NjY5ZjQyNzM0OWMzODA5ZDllZjMxNmNiMzJiMGUyYTMyNDFhY2NhNWNlNDBhNQ",
    ...
    public static function send_pushnotificationtoall($title,$content,$media="https://mylagosapp.mobi/images/logo.png") { //Function to send push notifications
        //Start cURL
                $curl = curl_init();
                curl_setopt_array($curl, array(
                CURLOPT_URL => "https://management-api.wonderpush.com/v1/deliveries?accessToken=Y2YzNGJkMDNlMTJlOTZjODk4NjY5ZjQyNzM0OWMzODA5ZDllZjMxNmNiMzJiMGUyYTMyNDFhY2NhNWNlNDBhNQ",
    ...
    public function getSubCategoryID($post)
    {
        ...
        $result=$subcategory->getSubcategorID($post);
        return $result;
    }

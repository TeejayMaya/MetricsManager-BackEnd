...
class Comments extends \Phalcon\Mvc\Model {
    ...
    {
        $query = "INSERT INTO comments (companyid, postid, userid, username, photo, type, status, details, time, date) VALUES (:companyid, :postid, :userid, :username, :photo, :type, :status, :details, :time, :date)";

...
class Notifications extends \Phalcon\Mvc\Model {
    ...
    {
        $query = "INSERT INTO notifications (title, details, fromid, from, type, status, userid, username, time, date) VALUES (:title, :details, :fromid, :from, :type, :status, :userid, :username, :time, :date)";
    ...
    public function sumEmergencies()
    {
        $query = "SELECT * FROM notifications WHERE type='emergency'";
        $result = $this->db->query($query, []); 
        return $result->numRows();
    }

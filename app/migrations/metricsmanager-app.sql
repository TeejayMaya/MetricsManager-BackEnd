...
--
-- Host: localhost:3306
-- Generation Time: Sep 24, 2020 at 09:22 PM
...
(1, 'Admin', NULL, 'Adewale', 'Adisa', 'info@metricsmanager.co', '08077018502', 'public/uploads/avatar.png', '$2y$08$S0pFbU4xbm02eFE2cDhFR.xInoMmZieJW0T11z/2fjkCQD7gX0bBi', '', '', '', '', '', '12-09-2020', '11ede2062c78896358d0', '', '05-12-2019'),
...
INSERT INTO `comments` (`id`, `companyid`, `postid`, `post`, `userid`, `username`, `usertype`, `photo`, `type`, `status`, `details`, `time`, `date`) VALUES
(1, 6, 4, NULL, '2', 'Olatunji Ogunkomaya', NULL, '', 'goals', 'approved', 'Going nice', '06:14:21am', '24-09-2020'),
(2, 6, 4, NULL, '2', 'Olatunji Ogunkomaya', NULL, '', 'goals', 'approved', 'Going nice', '06:14:31am', '24-09-2020'),
(3, 6, 4, NULL, '2', 'Olatunji Ogunkomaya', NULL, '', 'goals', 'approved', 'Going nice', '06:20:17am', '24-09-2020'),
(4, 6, 4, NULL, '2', 'Olatunji Ogunkomaya', NULL, '', 'goals', 'approved', 'Going nice', '06:25:28am', '24-09-2020'),
(5, 6, 4, NULL, '2', 'Olatunji Ogunkomaya', NULL, '', 'goals', 'approved', 'fine so far', '06:26:05am', '24-09-2020'),
(6, 6, 4, NULL, '2', 'Olatunji Ogunkomaya', NULL, '', 'goals', 'approved', 'fine so far', '06:26:18am', '24-09-2020'),
(7, 6, 4, NULL, '2', 'Olatunji Ogunkomaya', NULL, '', 'goals', 'approved', 'fine so', '06:33:32am', '24-09-2020'),
(8, 6, 4, NULL, '2', 'Olatunji Ogunkomaya', NULL, '', 'goals', 'approved', 'Progress\n', '06:34:33am', '24-09-2020'),
(9, 6, 4, NULL, '2', 'Olatunji Ogunkomaya', NULL, '', 'goals', 'approved', 'Progress\n', '06:38:09am', '24-09-2020'),
(10, 6, 4, NULL, '2', 'Olatunji Ogunkomaya', NULL, '', 'goals', 'approved', 'Going perfect now', '06:39:08am', '24-09-2020');
...
INSERT INTO `companies` (`id`, `companyname`, `companycode`, `photo`, `type`, `companyindustry`, `package`, `email`, `phone`, `userid`, `username`, `companyaddress`, `companycity`, `companystate`, `companycountry`, `companypostalzipcode`, `companywebsite`, `companyemployeescount`, `paymentstatus`, `referralcode`, `referrercode`, `verificationcode`, `verified`, `date`) VALUES
(6, 'CodePlay Technology', NULL, 'files/avatar.png', 'admin', 'Information & Communication Technology', '', 'info@codeplay.com.ng', '8057074642', 2, 'Olatunji Ogunkomaya', '9 Abdullahi crescent', 'Ojodu', 'Lagos', 'Nigeria', '', 'www.codeplay.com.ng', '5', '', '98023', '', '03818ee2841c97f9a1', 'no', '22-09-2020'),
(7, 'Strategos Company', NULL, 'files/avatar.png', 'admin', 'Consulting & Strategy', '', 'wale.adisa@strategoscompany.com', '8090335255', 3, 'Wale Adisa', 'Kolawole Ibirogba ', 'Gbagada', 'Lagos', 'Nigeria', '', 'www.strategoscompany.com', '3', '', '67444', '', '5f0a8934538d3d6b09', 'no', '22-09-2020');
...
--
-- Dumping data for table `companystructure`
--

INSERT INTO `companystructure` (`id`, `companyid`, `userid`, `username`, `level`, `parentlevel`, `categoryid`, `category`, `title`, `details`, `photo`, `date`) VALUES
(1, 6, 2, 'Olatunji Ogunkomaya', 'divisions', 'corporate', NULL, '', 'Web Host Division', 'Web hosting subsidiary of the company ', NULL, '22-09-2020'),
(3, 7, 3, 'Wale Adisa', 'departments', NULL, NULL, '', 'Consulting ', 'This Department handles all the client engagement', NULL, '22-09-2020'),
(4, 7, 3, 'Wale Adisa', 'departments', NULL, NULL, 'Consulting ', 'Consulting ', '', NULL, '22-09-2020'),
(5, 6, 2, 'Olatunji Ogunkomaya', 'departments', 'divisions', NULL, 'Web Host Division', 'Marketing Department', 'Marketing Department', NULL, '22-09-2020'),
(6, 7, 3, 'Wale Adisa', 'departments', 'corporate', NULL, '', 'Business Development', '', NULL, '22-09-2020');
...
INSERT INTO `goals` (`id`, `companyid`, `userid`, `username`, `title`, `type`, `level`, `target`, `targetdate`, `details`, `targetscore`, `result`, `score`, `rating`, `lastupdatedtime`, `lastupdateddate`, `time`, `status`, `safeurl`, `date`) VALUES
(1, 6, 2, 'Olatunji Ogunkomaya', '', '', '', '', '', '', 0, 'pending', 0, '0', NULL, NULL, '11:24 PM', 'pending', NULL, '22-09-2020'),
(2, 6, 2, 'Olatunji Ogunkomaya', '', '', '', '', '', '', 0, 'pending', 0, '0', NULL, NULL, '11:29 PM', 'pending', NULL, '22-09-2020'),
(3, 6, 2, 'Olatunji Ogunkomaya', '', '', '', '', '', '', 0, 'pending', 0, '0', NULL, NULL, '11:33 PM', 'pending', NULL, '22-09-2020'),
(4, 6, 2, 'Olatunji Ogunkomaya', 'Generate Revenue of 10 Million This Year', 'financials', 'divisions', 'Web Host Division', '2020-09-26', 'Revenue target', 50, 'completed', 10, '0', NULL, NULL, '05:50 AM', 'completed', NULL, '24-09-2020');
...
INSERT INTO `users` (`id`, `companyid`, `username`, `photo`, `type`, `firstname`, `lastname`, `email`, `phone`, `address`, `city`, `state`, `country`, `postalzipcode`, `position`, `lastlogindate`, `password`, `passwordsalt`, `logintoken`, `logindevice`, `referralcode`, `referrercode`, `referrerdetails`, `verificationcode`, `verified`, `passwordremindercode`, `passwordreminderdate`, `linkedinprofile`, `level`, `groupid`, `group`, `status`, `rating`, `result`, `date`) VALUES
(2, 6, 'Olatunji Ogunkomaya', 'files/avatar.png', 'admin', 'Olatunji', 'Ogunkomaya', 'info@codeplay.com.ng', '8057074642', NULL, NULL, NULL, NULL, NULL, 'CodePlay Technology', '22-09-2020', '$2y$08$TXE2SkRSNExRSkhid0pPdOLVjiEVkxJCDMepG.A7VFNYGrmCjvybi', NULL, '21c94daac79e81ea2917', NULL, '98023', '', '', '03818ee2841c97f9a1', 'no', NULL, NULL, 'https://www.linkedin.com/in/olatunji-ogunkomaya-75b45642/', 'corporate', NULL, '', NULL, NULL, NULL, '22-09-2020'),
(3, 7, 'Wale Adisa', 'files/avatar.png', 'admin', 'Wale', 'Adisa', 'wale.adisa@strategoscompany.com', '8090335255', NULL, NULL, NULL, NULL, NULL, 'CEO', '22-09-2020', '$2y$08$ZkJtVk9NTXZCYnZyV1QxQOcAB.tMObEttaNCPncqwG1KlB4q9Hu8C', NULL, 'def8237607077ed085da', NULL, '67444', '', '', '5f0a8934538d3d6b09', 'no', '9612', '24-09-2020', 'https://www.linkedin.com/in/waleadisa/', 'corporate', NULL, '', NULL, NULL, NULL, '22-09-2020'),
(4, 6, 'Teejay Maya', 'files/avatar.png', 'staff', 'Teejay', 'Maya', 'teejaymayaboss@gmail.com', '7063376828', NULL, NULL, NULL, NULL, NULL, 'Manager', NULL, '$2y$08$cVV3bUMrZHAxTzcxME1rceFAkcy1DqBX.ABYDKyHuZUxkWOp43DIu', NULL, NULL, NULL, '98144', NULL, '', 'ffaa50fa915ff23a57', 'no', NULL, NULL, 'https://www.linkedin.com/in/olatunji-ogunkomaya-75b45642/', 'divisions', NULL, 'Web Host Division', NULL, NULL, NULL, '24-09-2020');
